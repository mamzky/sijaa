    ...
    return (
      <View style={{ width: "100%", display: "flex", flexDirection: "row" }}>
        ...
        <div style={{ width: "70%", display: "flex", flexDirection: "column" }}>
          ...
          >{`PT. Kreasi Nurwidhi Grup`}</Text>
          <Text
            style={{ fontSize: 12, width: "100%", textAlign: "left" }}
          >{`Rehabilitation & General Hospital Equipment`}</Text>
          <Text
            style={{ fontSize: 12, width: "100%", textAlign: "left" }}
          >{`Bantar Jati, Setu, Cipayung, Jakarta Timur`}</Text>
        </div>
        <div style={{ width: "50%" }}>
          <Text
            style={{
    ...
    return (
      <View style={styles.tableRow}>
        <View style={styles.tableColHeaderNumber}>
          <Text
            style={{ fontSize: 8, textAlign: "center", paddingVertical: 4 }}
          >
            No
          </Text>
        </View>
        ...
        <div style={{ width: "100%", display: "flex", flexDirection: "row" }}>
          <div style={{ width: "45%", display: "flex", flexDirection: "col" }}>
            ...
            <div style={{ display: "flex", flexDirection: "row" }}>
              ...
              <Text style={{ width: "60%", fontSize: 11 }}>
                : {order?.order_number}
              </Text>
            </div>
            <div style={{ display: "flex", flexDirection: "row" }}>
            ...
            <div style={{ display: "flex", flexDirection: "row" }}>
              ...
              <Text style={{ width: "60%", fontSize: 12 }}>
                :{" "}
                {moment(order?.created_at).add("days", 30).format("DD/MM/YYYY")}
              </Text>
            </div>
          </div>
          <div style={{ width: "55%", display: "flex", flexDirection: "col" }}>
            <div style={{ display: "flex", flexDirection: "row" }}>
              ...
              <Text>{": "}</Text>
              <Text style={{ width: "80%", fontSize: 11 }}>
                {order?.customer?.name}
              </Text>
            </div>
            <div style={{ display: "flex", flexDirection: "row" }}>
              ...
              <View style={styles.tableRow} key={index}>
                ...
                <View style={[styles.tableColHeader, { width: "23%" }]}>
                  <Text style={{ fontSize: 8, textAlign: "right" }}>
                    {DigitFormatter(
                      Number(item?.price * item?.qty - (item?.disc ?? 0))
                    )}
                  </Text>
                </View>
              </View>
                ...
                <View style={styles.tableRow}>
                  <View style={[styles.tableColHeaderCenter, { width: "52%" }]}>
                    <Text style={{ fontSize: 8 }}>
                      Mandiri: 103 00000 89777 A/N. Kreasi Nurwidhi Grup
                    </Text>
                  </View>
                  <View style={[styles.tableColHeader, { width: "30%" }]}>
                    <Text style={{ fontSize: 8, textAlign: "center" }}>
                  ...
                  <View style={[styles.tableColHeader, { width: "23%" }]}>
                    <Text style={{ fontSize: 8, textAlign: "right" }}>
                      {order?.tax
                        ? DigitFormatter(
                            Number(
                              order?.total_bill.replaceAll(".", "") * 0.11
                            ).toFixed(0)
                          )
                        : "0"}
                    </Text>
                  ...
                  <View style={[styles.tableColHeader, { width: "23%" }]}>
                    <Text style={{ fontSize: 8, textAlign: "right" }}>
                      {order.tax
                        ? DigitFormatter(
                            Number(
                              order?.total_bill.replaceAll(".", "") * 1.11
                            ).toFixed(0)
                          )
                        : DigitFormatter(
                            Number(
                              order?.total_bill.replaceAll(".", "")
                            ).toFixed(0)
                          )}
                    </Text>
                  </View>
          ...
          <View style={styles.table}>
            ...
            {group.map((item, index) => (
              <View style={styles.tableRow} key={index}>
                ...
                <View style={[styles.tableColHeader, { width: "23%" }]}>
                  <Text style={{ fontSize: 8, textAlign: "right" }}>
                    {DigitFormatter(Number(item?.price))}
                  </Text>
                </View>
                <View style={[styles.tableColHeader, { width: "23%" }]}>
                  <Text style={{ fontSize: 8, textAlign: "right" }}>
                    {DigitFormatter(Number(item?.price * item?.qty))}
                  </Text>
                </View>
              </View>
            ))}
