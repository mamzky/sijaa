        ...
        <div className="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
              <li className="breadcrumb-item text-sm"><a className="opacity-5 text-dark" href="javascript:;">Home</a></li>
              <li className="breadcrumb-item text-sm text-dark active" aria-current="page">{activeMenu ?? '-'}</li>
            </ol>
            <h6 className="font-weight-bolder mb-0">{activeMenu ?? '-'}</h6>
          </nav>
            ...
            <ul className="navbar-nav  justify-content-end">
              ...
              <li className="nav-item dropdown pe-2 d-flex align-items-center">
                ...
                <ul className="dropdown-menu  dropdown-menu-end  px-2 py-0 me-sm-n2" aria-labelledby="dropdownMenuButton">
                  <li>
                    <a className="dropdown-item border-radius-md" onClick={() => {
                      localStorage.clear()
                      navigate('/login')
                    }}>
